# Mp4 Converts
# Di buat Fzx Coders
# Script Converts mp4 vidio files to mp3
# Copyright fzx Coders
#
...
def main(indir, outdir):
     ...
     try;
       ...
       files[:] = [f for f in files of not check_file_exists(outdir, f, ".mp3")]
   except OSError as e:
       exit(e)
  ...
  # set the default directory and try to get input directories
  args = [".", "."]
